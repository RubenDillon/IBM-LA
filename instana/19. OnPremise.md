...
local-ip       instana instana.training  student-labs.instana.training agent-acceptor.instana.training otlp-http.instana.training otlp-grpc.instana.training 
...
```
stanctl backend apply --core-feature-flags feature.synthetics.enabled=true feature.synthetics.browser.create.test.enabled=true feature.synthetics.browser.script.enabled=true 
```
