...
- 16 vCPU
- 64 GB RAM
- six large filesystems to store data or only one large filesystem (2TB) for a demo environment
     ...
     - /var at least 60 GB
     - /home at least 40 GB
- Linux Operating System (we will be using RHEL 9.2) or Ubuntu 22.04 (at the end of this document)
...
Prepare the environment in RHEL Environment
-

NOTE: IF you prefer to use Ubuntu instead of RHEL, go to the end of this document.
...
----
NOTE: The DOWNLOAD KEY (AgentKey) (and the SALES KEY) IBMers and IBM Business Partners can get license keys from the Partner Access to Instana presentation. https://ibm.github.io/waiops-tech-jam/labs/instana/opentelemetry/lab-environment/#:~:text=Partner%20Access%20to%20Instana  o https://ibm.seismic.com/Link/Content/DCQfMjDgqWT2B87FWXPhGXQbJGDP
...
<img width="1098" height="618" alt="image" src="https://github.com/user-attachments/assets/43fd1152-2d8c-4727-8dfb-87a0a472f901" />

The image is an example of what it look like.
...
# Deploying Instana using Ubuntu Server
...
Tiempos de instalacion para la version 3.313.465-0

<img width="1024" height="488" alt="image" src="https://github.com/user-attachments/assets/af64caa1-e300-4778-98a9-006e21576f56" />
...
dejar el localhost
ip fqdn fqdn con todos los parametros ..... ultimo, el nombre del host solo 

(borrar el host solo con 127.0.0.1)
