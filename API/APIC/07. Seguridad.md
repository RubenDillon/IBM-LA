...
Este tutorial demuestra cómo proteger el uso de tu API.
...
- Que la aplicación que llama a la API está autorizada.
...
- No permite roles, permisos ni revocación por usuario.
