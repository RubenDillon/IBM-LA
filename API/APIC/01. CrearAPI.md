...
o mas adelante... usando Spring Boot con maven
...
<head>
  <meta charset="UTF-8">
  <title>Búsqueda de Cliente - Spring Boot</title>
</head>
<body>
  <h1>Búsqueda de Cliente</h1>
  <form action="/clienteAppSpring/buscar" method="get">
...
Vamos a mejorar la interfaz de usuario
=

If a /opt/springcliente/clienteApp/src/main/java/com/example/clienteApp

Copiar el archivo ClienteAppApplication.java para mantenerlo de resguardo y crear uno nuevo
```
vi /opt/springcliente/clienteApp/src/main/java/com/example/clienteApp/ClienteController.java
```
...
public class ClienteController {
    ...
    @GetMapping("/cliente")
    public String getCliente(@RequestParam int id) {

        // Aquí va la lógica real de consulta.
        // En este ejemplo devolvemos un texto simulado.
        // Podés reemplazarlo luego con JDBC o tu API actual.
        String resultado = "Cliente encontrado: " + id;

        // Devolvemos HTML completo, con formulario para re-consultar
        return "<!DOCTYPE html>" +
                "<html>" +
                "<head><title>Consulta de Clientes</title></head>" +
                "<body>" +
                "<h2>Resultado de la consulta</h2>" +
                "<p>" + resultado + "</p>" +

                "<hr>" +
                "<h3>Consultar otro cliente</h3>" +
