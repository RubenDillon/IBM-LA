...
## 🖥️ VM1: Servidor Front‑end (Apache Tomcat + Java) opcion 1 . prueba
...
#########################################
# 4. Servlet Java que llama la API vía fetch HTTP
#########################################
...
public class ConsultaCliente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Llamado a la API vía proxy Apache
...
#########################################
# 6. Crear página HTML simple para buscar el cliente
#########################################
...
# Modificar  /etc/httpd/conf/httpd.conf

# Reverse proxy para acceder a Tomcat (clienteApp) desde Apache:8080
...
echo "Aplicación Java desplegada en: http://<IP>:8080/clienteApp"



```

## 🖥️ VM1: Servidor Front‑end (Apache Tomcat + Java) opcion 2 . prueba sin tanta ida y vuelta...
