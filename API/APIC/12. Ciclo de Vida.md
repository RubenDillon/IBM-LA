...
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/41939a6e-7d59-4902-af24-f3f787b1b4f6" />
...
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/cc8548d4-5085-4909-85a3-a27f61acf359" />


2) Si se para en sus productos, podra ver como avanzar con el cambio
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/c35f25f8-ba7f-423d-868f-865fa8aa598f" />

<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/271eb29e-3427-4bbe-a878-0ff1308ecd4b" />


Actualizando la API del Producto 2.0.0
-

1) Para proceder con la actualizacion de la API del Producto 2.0.0, vamos a APIC y a Develop. Selecciono Product y Update APIs
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/9a96d7af-e9f4-40aa-9961-1c5bcc667974" />


2) Selecciono las dos APIs nuevas
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/14b8d5f6-f004-4feb-8bde-fd13f08378af" />


3) Ingreso al producto 2.0.0 para visualizar que se encuentrar ambas APIs disponibles
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/1fbef77a-4a61-4938-9e33-4d40c00db04c" />

4) Luego selecciono Publish
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/4ad27afc-44b6-4c96-8c1f-13b6d79a600e" />

<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/2d7ad76a-6c64-4c1e-a5bc-ad46a47540bf" />

<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/ee42098e-9e99-46fa-908a-4824e7fec34c" />


5) Vamos a Manage y veremos las dos APIs en el catalogo
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/6d1391a5-47b0-4724-9b14-868c899e926b" />

<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/abd324ad-cddb-4207-adf8-4591cff8fdc4" />


6) Si vamos al portal de desarrolladores, veremos que hay dos APIs en la version 2.0.0  
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/c6c1f0db-449d-4024-8863-4e068a6d4e21" />


7) Si vamos a la operaciones de la version 2.0.0, veremos que estan limitadas versus la version 1.0.0 (no esta PUT ni DELETE)
<img width="1714" height="1074" alt="image" src="https://github.com/user-attachments/assets/1da3ba7a-8c3c-431c-bd4e-4c54e88ae188" />
