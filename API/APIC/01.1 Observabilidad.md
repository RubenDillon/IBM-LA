...
2) Modificar el archivo de inicio del servicio
...
ExecStart=/usr/bin/java \
  -javaagent:/opt/instana/agent/javaagent.jar \
  -jar /opt/springcliente/clienteApp/target/clienteApp-0.0.1-SNAPSHOT.jar
