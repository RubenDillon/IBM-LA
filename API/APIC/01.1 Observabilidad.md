...
En el archivo /opt/springcliente/clienteApp/pom.xml agregar el siguiente bloque dentro de dependecy
...
El archivo src/main/resources/application.properties debe quedar de la siguiente manera
...
spring.application.name=clienteApp_MyAPI
```

2) Volver a construir la app

```
mvn clean package -DskipTests
```

3) Luego debe volver a reiniciarse en orden, el servicio y clienteApp
...
Se deberia dejar de ver la JVM y pasar a visualizar Spring Boot

<img width="1779" height="924" alt="image" src="https://github.com/user-attachments/assets/090f2bcf-bf87-47fc-8e95-51830f198435" />
