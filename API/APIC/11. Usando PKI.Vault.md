...
Una forma diferente de trabajar con las bases de datos y Vault, es el uso de secretos dinamicas 

https://developer.hashicorp.com/vault/tutorials/db-credentials/database-secrets?variants=vault-deploy%3Aselfhosted

La idea es dejar a Vault en el manejo y administracion de credenciales. Desde la interfaz uno puede solicitar nuevas credenciales, que son temporales y duran el tiempo definido en el TTL o utilizando alguna otra variante (cliente de vault, curl..)
