...
Durante este apartado, estos son los siguientes pasos que daremos
- Crear una API GraphQL con un enfoque declarativo usando API Connect para GraphQL.
- Crear una API GraphQL usando diferentes fuentes (dos servicios REST y una base de datos PostgreSQL).
- Crear una composición gráfica usando @materializer.
- Implementar la nueva API GraphQL en API Connect para el entorno de ejecución GraphQL Cloud.
- Crear una API proxy GraphQL en API Connect para llamar a la API GraphQL en API Connect para GraphQL.
- Gestionar su API y configurar las políticas de seguridad.
- Opcional. Crear un producto y apliqué límites de velocidad de GraphQL.
- Opcional. Socializar su API GraphQL en el Portal para desarrolladores y demostré cómo un consumidor de API puede usar el portal para realizar el autoconsumo de la API.
...
<img width="1561" height="879" alt="image" src="https://github.com/user-attachments/assets/1a2c8da3-418c-40fa-9aed-e398d3cf5fd6" />
...
Si deseamos agregar estos valores en la llamada directamente, podemos agregar una variable en el Gateway. PAra ello, vamos a Gateway. Bajamos a Otherwise (como antes) y antes del graphql-invoke en el simbolo +, seleccionamos un assembly del tipo Set Variable.

<img width="1561" height="879" alt="image" src="https://github.com/user-attachments/assets/545adf7f-f8d2-48b6-ab80-673558b370f3" />

<img width="1561" height="1107" alt="image" src="https://github.com/user-attachments/assets/5b9825b3-da6b-4270-94eb-60ac04552358" />

Completamos el bloque Set Variable colocando el nombre al titulo

<img width="1561" height="636" alt="image" src="https://github.com/user-attachments/assets/e3095eaa-93bb-4e9d-9a9e-9161b992c225" />

Creamos una Accion, con los siguientes valores (Set como tipo de accion, message.headers.Authorization como el nombre de la variable por agregar un valor y que sea del tipo String)

<img width="1561" height="1118" alt="image" src="https://github.com/user-attachments/assets/a8fc29ed-59d2-44bb-b1df-6bc3a0d2ffa3" />

Guardar y volver a Test, para probar los cambios.

<img width="1561" height="1118" alt="image" src="https://github.com/user-attachments/assets/4e8666e0-9603-48d0-88c6-6d9692cee711" />
