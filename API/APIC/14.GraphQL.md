...
El primer paso sera conectarnos al motor de base de datos de nuestra aplicacion.

Previo a realizar esta conexion, debemos trabajar los permisos del motor. Debemos crear el usuario que vamos a usar para conectarnos desde API Connect Essentials, darle permisos a las bases y de ese modo, poder obtener la conexion.

<img width="1163" height="76" alt="image" src="https://github.com/user-attachments/assets/5fe5131f-629f-4dfb-935f-a7c0efd0c75a" />

NOTA: Para obtener el ec2 desde donde se va a realizar la conexion, desde la consola de VS Code ejecutar la linea de stepzen import mysql la cual dara error. De ahi, se puede obtener el ec2-52-55-x-x.compute-1.amazonaws.com
...
```
stepzen import mysql --db-host='150.240.2.210:8080' --db-database='clientes_db' --db-user='apiuser' --db-password='apipass' --name=mysql
```
